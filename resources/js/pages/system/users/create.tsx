...
export default function CreateUser() {
    const { roles } = usePage().props as any as CreateProps;
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        router.post(route('system.users.store'), formData, {
    ...
    return (
        <AppLayout breadcrumbs={[{ label: 'System' }, { label: 'Users', href: route('system.users.index') }, { label: 'Create User' }]}>
            <div className="max-w-2xl">
                <div className="mb-8">
                    ...
                    <h1 className="text-3xl md:text-4xl font-black tracking-tighter">Create User</h1>
                </div>
